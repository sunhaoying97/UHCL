...
# Tuning Params
LEARNING_RATE=(7e-6 ) ##7e-5 1e-5 3e-5  1e-4 3e-4 7e-4)
#LEARNING_RATE=(7e-6 1e-5 3e-5  7e-5 1e-4 3e-4 7e-4)
...
do
  ...
  --epochs=25 --batch_size=128 --n_display=50 --gradient_accumulation_steps 1 \

...
🎉 This repository is the official implementation of the paper **"Unified Hierarchical Contrastive Learning for Video Caption"**. The paper has now been accepted by the JCR Q1 and SCI Q1 journal [**"Information Fusion"**](https://www.sciencedirect.com/science/article/abs/pii/S1566253525009182).
